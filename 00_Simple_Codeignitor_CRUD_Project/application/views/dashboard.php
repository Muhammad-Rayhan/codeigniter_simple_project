                ...
                <ul class="navbar-nav navbar-nav-right">
                    ...
                    <li class="nav-item nav-profile dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="<?= base_url() ?>log-in">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="theme-setting-wrapper">
                ...
                <div id="theme-settings" class="settings-panel">
                    ...
                    <div class="sidebar-bg-options selected" id="sidebar-dark-theme">
                        <div class="img-ss rounded-circle bg-primary border mr-3"></div>Dark
                    </div>
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url(); ?>course-details">
            ...
            <div class="main-panel">
                ...
                <!-- Show alert messeage start -->
                <?php echo $main_content; ?>
                <!-- Show alert messeage end -->
    ...
    <script>
        $(document).ready(function() {
            $('.editbtn').on('click', function() { //'.editbtn' = original edit button class name declear.
                $('#editmodal').modal('show'); //modal by id. '#editmodal' = show modal id name.
            });
        });
    </script>
    <!-- Jquery 2.2.4 link -->
