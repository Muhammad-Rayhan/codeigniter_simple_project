            ...
            <div class="row justify-content-center">
                <div class="col-5 rounded border px-3 py-3" style="background-color: #fff;">
                    <form action="<?= base_url();?>login" method="post">
                        ...
                        <div class="mb-3">
                            <label for="exampleInputUser1" class="form-label">User Name</label></label>
                            <input type="text" class="form-control" id="exampleInputUserl1" aria-describedby="emailHelp" name="user">
                        </div>
                        <div class="mb-3">
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <div class="mb-4">
                            <button type="submit" class="btn w-100" style="background-color: #ee5684; color: #fff;" name="save">SIGN UP</button>
                        </div>
                        <div class="mb-3 pt-1">
                            <hr class="hr">
                        ...
                        <div class="mb-3 pt-1">
                            <p class="d-flex justify-content-center">Already a user? <a href="<?= base_url() ?>log-in" class="text-dark ms-1">LOGIN</a></p>
                        </div>
                    </form>
                </div>
            </div>
