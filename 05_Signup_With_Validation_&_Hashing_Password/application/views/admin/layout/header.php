                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="py-lg-2 pr-lg-2">
                                <img src="<?= base_url()?>assets/images/illustrator/1.png" alt="" class="img-fluid mx-auto" style="max-height: 250px;">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0">
                    ...
                    <div data-simplebar style="max-height: 270px;">
                        ...
                        <a class="notification-item text-reset" href="#!">
                            <div class="d-flex border-bottom align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="<?= base_url()?>assets/images/brands/behance.png" alt="behance">
                                </div>
                                <div class="flex-grow-1 ms-4">
                    ...
                    <div data-simplebar style="max-height: 250px;">
                        ...
                        <a href="#" class="text-reset notification-item">
                            <div class="d-flex border-bottom align-items-start">
                                <div class="flex-shrink-0">
                                    <img src="<?= base_url()?>assets/images/users/avatar-3.jpg" class="me-3 rounded-circle avatar-sm" alt="user-pic">
                                </div>
                        ...
                        <a href="#" class="text-reset notification-item">
                            <div class="d-flex border-bottom align-items-start">
                                <div class="flex-shrink-0">
                                    <img src="<?= base_url()?>assets/images/users/avatar-4.jpg" class="me-3 rounded-circle avatar-sm" alt="user-pic">
                                </div>
                                <div class="flex-grow-1">
