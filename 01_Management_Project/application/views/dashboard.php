...
<!-- Mirrored from preview.pichforest.com/dashonic/layouts/apps-calendar.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 May 2022 09:02:58 GMT -->

<head>

    <meta charset="utf-8" />
    <title>Calendar | Dashonic - Admin & Dashboard Template</title>
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="<?= base_url() ?>dashboard">
                                ...
                                <span class="menu-item" data-key="t-sales">Student info</span>
                        ...
                        <li>
                            <a href="<?= base_url() ?>course">
                                <i class="icon nav-icon" data-feather="monitor"></i>
                                <span class="menu-item" data-key="t-sales">Course</span>
                            </a>
                        </li>
